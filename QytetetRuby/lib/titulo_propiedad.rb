...
module ModeloQytetet
  ...
  class TituloPropiedad
    ...
    def to_s
      puts "nombre: #{nombre}, hipotecada: #{hipotecada}, precioCompra: #{precioCompra}, alquilerBase: #{alquilerBase}, factorRevalorizacion: #{factorRevalorizacion}, hipotecaBase: #{hiptecaBase}, precioEdificar: #{precioEdificar}, numHoteles: #{numHoteles}, numCasas: #{numCasas}\n"
    end
